...
function optionSearchMetadata(optionKey) {
  const aliases = {
    ...
    headless_source: ["virtual screen backend", "evdi", "dummy plug", "headless source"],
    headless_swap_mode: ["move desktop to headless", "swap primary", "privacy", "keep monitor on", "extended", "mirror", "dummy plug primary", "headless swap", "streaming display arrangement"],
