...
function captureReasonDescription(reason) {
  ...
  const messages = {
    ...
    headless_shm_fallback: 'Headless Stream is using SHM/system-memory capture; healthy streams can still show this, but capable high-FPS NVIDIA hosts should use the GPU-native path.',
    headless_shm_default: 'Headless Stream is using SHM/system-memory capture; healthy streams can still show this, but capable high-FPS NVIDIA hosts should use the GPU-native path.',
