...
runtime='dbus pipewire pipewire-pulse pipewire-bin libspa-0.2-modules libpipewire-0.3-modules pulseaudio-utils gstreamer1.0-tools gstreamer1.0-plugins-base gstreamer1.0-gl gstreamer1.0-plugins-good gstreamer1.0-plugins-bad libegl1 libgbm1 libgl1 libvulkan1 libwayland-client0 xwayland'
