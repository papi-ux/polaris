...
set(CPACK_PACKAGE_ICON ${PROJECT_SOURCE_DIR}/polaris.png)
set(CPACK_PACKAGE_FILE_NAME "${CMAKE_PROJECT_NAME}")
set(CPACK_STRIP_FILES YES)

# install common assets
install(DIRECTORY "${POLARIS_SOURCE_ASSETS_DIR}/common/assets/"
        DESTINATION "${POLARIS_ASSETS_DIR}"
        PATTERN "web" EXCLUDE)
# copy assets to build directory, for running without install
file(GLOB_RECURSE ALL_ASSETS
        RELATIVE "${POLARIS_SOURCE_ASSETS_DIR}/common/assets/" "${POLARIS_SOURCE_ASSETS_DIR}/common/assets/*")
...
foreach(asset ${ALL_ASSETS})  # Copy assets to build directory, excluding the web directory
    file(COPY "${POLARIS_SOURCE_ASSETS_DIR}/common/assets/${asset}"
