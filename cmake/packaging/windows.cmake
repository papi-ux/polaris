...
install(TARGETS polaris RUNTIME DESTINATION "." COMPONENT application)
...
# Mandatory tools
install(TARGETS polarissvc RUNTIME DESTINATION "tools" COMPONENT application)

# Drivers
install(DIRECTORY "${POLARIS_SOURCE_ASSETS_DIR}/windows/drivers/sudovda"
        DESTINATION "drivers"
        COMPONENT sudovda)

# Mandatory scripts
install(DIRECTORY "${POLARIS_SOURCE_ASSETS_DIR}/windows/misc/service/"
        DESTINATION "scripts"
        COMPONENT assets)
install(DIRECTORY "${POLARIS_SOURCE_ASSETS_DIR}/windows/misc/migration/"
        DESTINATION "scripts"
        COMPONENT assets)
install(DIRECTORY "${POLARIS_SOURCE_ASSETS_DIR}/windows/misc/path/"
        DESTINATION "scripts"
        COMPONENT assets)

# Configurable options for the service
install(DIRECTORY "${POLARIS_SOURCE_ASSETS_DIR}/windows/misc/autostart/"
        DESTINATION "scripts"
        COMPONENT autostart)

# scripts
install(DIRECTORY "${POLARIS_SOURCE_ASSETS_DIR}/windows/misc/firewall/"
        DESTINATION "scripts"
        COMPONENT firewall)
install(DIRECTORY "${POLARIS_SOURCE_ASSETS_DIR}/windows/misc/gamepad/"
        DESTINATION "scripts"
        COMPONENT gamepad)

# Polaris assets
install(DIRECTORY "${POLARIS_SOURCE_ASSETS_DIR}/windows/assets/"
        DESTINATION "${POLARIS_ASSETS_DIR}"
        COMPONENT assets)

# copy assets (excluding shaders) to build directory, for running without install
file(COPY "${POLARIS_SOURCE_ASSETS_DIR}/windows/assets/"
        DESTINATION "${CMAKE_BINARY_DIR}/assets"
        PATTERN "shaders" EXCLUDE)
# use junction for shaders directory
cmake_path(CONVERT "${POLARIS_SOURCE_ASSETS_DIR}/windows/assets/shaders"
...
set(CPACK_PACKAGE_ICON "${CMAKE_SOURCE_DIR}\\\\polaris.ico")
...
set(CPACK_COMPONENT_AUTOSTART_DESCRIPTION "If enabled, launches Polaris automatically on system startup.")
