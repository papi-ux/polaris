...
add_compile_definitions(POLARIS_PLATFORM="windows")
...
list(APPEND POLARIS_COMPILE_OPTIONS -Wno-misleading-indentation)
...
if(NOT DEFINED PROJECT_ICON_PATH)
    set(PROJECT_ICON_PATH "${CMAKE_SOURCE_DIR}/polaris.ico")
endif()

# Create a separate object library for the RC file with minimal includes
add_library(polaris_rc_object OBJECT "${CMAKE_SOURCE_DIR}/src/platform/windows/windows.rc")
...
set_target_properties(polaris_rc_object PROPERTIES
    COMPILE_DEFINITIONS "PROJECT_ICON_PATH=${PROJECT_ICON_PATH};PROJECT_NAME=${PROJECT_NAME};PROJECT_VENDOR=${POLARIS_PUBLISHER_NAME};PROJECT_VERSION=${PROJECT_VERSION};PROJECT_VERSION_MAJOR=${PROJECT_VERSION_MAJOR};PROJECT_VERSION_MINOR=${PROJECT_VERSION_MINOR};PROJECT_VERSION_PATCH=${PROJECT_VERSION_PATCH}"  # cmake-lint: disable=C0301
    INCLUDE_DIRECTORIES ""
)
