...
<table>
    <tr>
        <td>Description</td>
        <td colspan="2">
            Commands that run when Polaris resumes streaming or pauses after the last client disconnects.
            Use the `do` action for resume and the `undo` action for pause.
        </td>
    </tr>
    <tr>
        <td>Default</td>
    ...
    <tr>
        <td>Example</td>
        <td colspan="2">@code{}
            global_state_cmd = [{"do":"systemctl --user start gamemode","undo":"systemctl --user stop gamemode"}]
            @endcode</td>
    </tr>
</table>
...
<table>
    <tr>
        <td>Description</td>
        <td colspan="2">
            Hide the "Force Stop", "Restart", and "Quit" entries from the tray menu.
        </td>
    </tr>
    <tr>
        <td>Default</td>
...
<table>
    <tr>
        <td>Description</td>
        <td colspan="2">
            Allow Moonlight clients to pair with this host.
        </td>
    </tr>
    <tr>
        <td>Default</td>
...
<table>
    <tr>
        <td>Description</td>
        <td colspan="2">
            Advertise the host for automatic discovery on the local network.
        </td>
    </tr>
    <tr>
        <td>Default</td>
...
<table>
    <tr>
        <td>Description</td>
        <td colspan="2">
            Optional SteamGridDB API key used when Polaris fetches artwork for applications.
        </td>
    </tr>
    <tr>
        <td>Default</td>
...
<table>
    <tr>
        <td>Description</td>
        <td colspan="2">
            Add an Input Only entry that forwards controls without sending video or audio.
        </td>
    </tr>
    <tr>
        <td>Default</td>
...
<table>
    <tr>
        <td>Description</td>
        <td colspan="2">
            Forward controller rumble messages to connected clients.
        </td>
    </tr>
    <tr>
        <td>Default</td>
...
<table>
    <tr>
        <td>Description</td>
        <td colspan="2">
            Keep the selected virtual sink as the default host audio output when host playback is disabled.
        </td>
    </tr>
    <tr>
        <td>Default</td>
...
<table>
    <tr>
        <td>Description</td>
        <td colspan="2">
            Automatically capture the currently active default audio sink after it changes.
        </td>
    </tr>
    <tr>
        <td>Default</td>
...
<table>
    <tr>
        <td>Description</td>
        <td colspan="2">
            Display mode Polaris should use when the client does not request one or when launching from the web UI.
...
<table>
    <tr>
        <td>Description</td>
        <td colspan="2">
            Start streaming in headless mode. This is primarily used for Linux virtual display workflows.
        </td>
    </tr>
    <tr>
        <td>Default</td>
...
<table>
    <tr>
        <td>Description</td>
        <td colspan="2">
            Prefer GPU-native capture paths on Linux, even if Polaris must run the labwc compositor windowed instead of truly headless.
            This is primarily useful with GPU-backed encoders such as NVENC and VAAPI, where SHM fallback is usually a performance regression.
        </td>
    </tr>
    <tr>
        <td>Default</td>
...
### linux_capture_profile

<table>
    <tr>
        <td>Description</td>
        <td colspan="2">
            Enable Linux capture telemetry profiling. Polaris records capture dispatch, ingest, and total timings,
            then emits transport-tagged p50/p99 summaries every 600 frames.
        </td>
    </tr>
    <tr>
        <td>Default</td>
...
<table>
    <tr>
        <td>Description</td>
        <td colspan="2">
            Double the requested refresh rate when creating a virtual display while keeping the streamed refresh rate unchanged.
            @note{Applies to Windows only.}
        </td>
    </tr>
    <tr>
...
<table>
    <tr>
        <td>Description</td>
        <td colspan="2">
            Enable adaptive bitrate adjustments based on packet loss and latency changes.
        </td>
    </tr>
    <tr>
        <td>Default</td>
...
<table>
    <tr>
        <td>Description</td>
        <td colspan="2">
            Minimum bitrate floor in Kbps when adaptive bitrate is enabled.
        </td>
    </tr>
    <tr>
        <td>Default</td>
...
<table>
    <tr>
        <td>Description</td>
        <td colspan="2">
            Maximum bitrate ceiling in Kbps when adaptive bitrate is enabled.
        </td>
    </tr>
    <tr>
        <td>Default</td>
...
<table>
    <tr>
        <td>Description</td>
        <td colspan="2">
            List of trusted client subnets that may use trust-on-first-use pairing behavior.
        </td>
    </tr>
    <tr>
        <td>Default</td>
...
<table>
    <tr>
        <td>Description</td>
        <td colspan="2">
            Limit capture to the frame rate requested by the client.
        </td>
    </tr>
    <tr>
        <td>Default</td>
...
<table>
    <tr>
        <td>Description</td>
        <td colspan="2">
            Preserve legacy environment variable behavior for older scripts and tools.
        </td>
    </tr>
    <tr>
        <td>Default</td>
...
<table>
    <tr>
        <td>Description</td>
        <td colspan="2">
            Enable app ordering compatibility for legacy clients that expect older sorting behavior.
        </td>
    </tr>
    <tr>
        <td>Default</td>
...
<table>
    <tr>
        <td>Description</td>
        <td colspan="2">
            Continue startup even if encoder probing fails.
        </td>
    </tr>
    <tr>
        <td>Default</td>
...
<table>
    <tr>
        <td>Description</td>
        <td colspan="2">
            Enable AI-assisted stream optimization recommendations.
        </td>
    </tr>
    <tr>
        <td>Default</td>
...
<table>
    <tr>
        <td>Description</td>
        <td colspan="2">
            Maximum time in milliseconds to wait for an AI optimization response.
        </td>
    </tr>
    <tr>
        <td>Default</td>
...
<table>
    <tr>
        <td>Description</td>
        <td colspan="2">
            Enable intra refresh for clients that require it for stable rendering.
        </td>
    </tr>
    <tr>
        <td>Default</td>
